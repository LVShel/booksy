...
-- Simulate old books (created 200 days ago)
    (5, '9780000000005', 'Ancient Times', 15.99, 'OLD_EDITION', 3, DATEADD('DAY', -200, CURRENT_TIMESTAMP), 'ACTIVE'),
    (6, '9780000000006', 'Very old book', 25.50, 'REGULAR', 2, DATEADD('DAY', -220, CURRENT_TIMESTAMP), 'ACTIVE');
